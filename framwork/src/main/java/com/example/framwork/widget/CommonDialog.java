...
public class CommonDialog extends Dialog  implements View.OnClickListener{
    ...
    public void setValue(String title, String info, String confirmBtn, String cancelBtn, String doNotShowAgain,
        ...
        DLog.i(TAG, "dialog title:" + title + "  mes:0" + info + " positiveBtn:" + confirmBtn + " negativeBtn:" + cancelBtn + " not_tip:" + doNotShowAgain + " callback" + callback);
        mTitle = title;
        mInfoText = info;
    ...
    public static class Builder {
        ...
        public CommonDialog show() {
            DLog.i(TAG, " title " + mTitle + " message" + mInfoText + "  show()  to be invoked");
